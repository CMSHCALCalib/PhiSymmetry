...
usage = "usage: python ../scripts/splitAndSubmit.py -t phiSym_template_alcareco.py -q cmscaf1nh -i fileList_egamma+singlemu.txt -o phisym -p /eos/cms/store/group/dpg_hcal/comm_hcal/deguio/PhiSymm2018 --split 3"
